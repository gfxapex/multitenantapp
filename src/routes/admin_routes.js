...
router
  ...
  .patch(verifyUser(PERMISSIONS.ADMIN.DELETE_ROLE_FROM_USER), deleteRoleFromUser);

router
  .route("/user/permission")
  .post(verifyUser(PERMISSIONS.ADMIN.ADD_PERMISSION_TO_USER), addPermissionToUser)
  .patch(verifyUser(PERMISSIONS.ADMIN.DELETE_PERMISSION_FROM_USER), deletePermissionFromUser);
...
router
  ...
  .post(verifyUser(PERMISSIONS.ADMIN.ADD_PERMISSION_TO_ROLE), addPermissionToRole)
  .patch(verifyUser(PERMISSIONS.ADMIN.DELETE_PERMISSION_FROM_ROLE), deletePermissionFromRole);
